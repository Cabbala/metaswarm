...
**Tip:** Use `bd create "Decision: <decision>: <rationale>" -t decision` to record decisions persistently in the beads database — these survive compaction and are available across sessions.
