...
This project is **metaswarm** — a multi-agent orchestration framework for Claude Code and Codex CLI. It provides 19 specialized agents, 13 orchestration skills, quality gates, and TDD enforcement.
