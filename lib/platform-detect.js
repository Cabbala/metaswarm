...
function detectClaude() {
  ...
  return {
    ...
    installCommand: 'claude plugin marketplace add Cabbala/metaswarm && claude plugin install metaswarm@metaswarm',
...
function detectCodex() {
  ...
  return {
    ...
    pluginCacheDir,
    installMethod: 'plugin',
    installCommand: 'codex plugin marketplace add Cabbala/metaswarm && codex plugin add metaswarm@metaswarm',
    setupCommand: '$setup',
...
function detectGemini() {
  ...
  return {
    ...
    installCommand: 'gemini extensions install https://github.com/Cabbala/metaswarm.git',
    setupCommand: '/metaswarm:setup',
